...
covariate_file = "/home/masoud/GA_data/GA-cover2/sirsam_covariates_Na.txt" # For Sirsam dataset
...
input_data = "/home/masoud/GA_data/GA-cover2"; 
#input_data = "/short/ge3/jrw547/GA-cover2"
#input_data = "/g/data/ge3/covariates/Sites/geochem"
...
#road_shapefile_name = "Roads_Sir_Sam"  # Line segments
#Buffer_Sample(covariate_file, input_data, road_shapefile_name, exp_folder, no_samples, width, existing_model)
...
#shapefile_name = "geochem_sites" # geochem_sites_log Traget points
#sample_balanced(covariate_file, input_data, shapefile_name, exp_folder, no_samples)

#LHS from a shapefile
#sample_lhs_1D(input_data, shapefile_name, exp_folder, no_samples)
